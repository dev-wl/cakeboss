...
if ( function_exists('register_sidebar') ) {
        ...
        register_sidebar(array(
            'name' => 'Main Sidebar',
            'id' => 'main-sidebar',
            'description' => 'Appears as the sidebar on blog post',
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget' => '</div>',
            'before_title' => '<div class="caption cf"><h3 class="firstfont colormain">',
            'after_title' => '</h3><div class="line-cake"><div class="cake"></div><div class="line lleft"></div><div class="line lright"></div></div></div>',
        ));

        register_sidebar(array(
            'name' => 'WooCommerce Sidebar',
            'id' => 'woocommerce-sidebar',
            'description' => 'Appears as the sidebar on shop single page',
            'before_widget' => '<div id="%1$s" class="widget %2$s">',
            'after_widget' => '</div>',
            'before_title' => '<div class="caption cf"><h3 class="firstfont colormain">',
            'after_title' => '</h3><div class="line-cake"><div class="cake"></div><div class="line lleft"></div><div class="line lright"></div></div></div>',

...
if ( ! class_exists( 'Aletheme_export_import_options' ) ) {
    ...
    class Aletheme_export_import_options
    {
        ...
        {
            global $wpdb;
            return $wpdb->get_results("SELECT option_name, option_value FROM {$wpdb->options} WHERE option_name = 'cafeteriaresponsivewordpresstheme'"); // edit 'option_name' to match theme options
        }
    }
}

    ...
    <div class="most-commented cf">
            ...
            <?php  if (get_the_post_thumbnail($post->ID)) :  ?>
                <div class="comment cf">
                    ...
                    <h2 class="firstfont cap"><a class="whitelink" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
                    <p class="date"><?php printf(_n('One comment', '%1$s Comments', get_comments_number(), 'aletheme'), number_format_i18n(get_comments_number())); ?></p>
                </div>
                <?php else: ?>
                    <div class="comment cf">
                        <h2 class="firstfont cap"><a class="whitelink" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>

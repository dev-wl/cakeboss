...
** PLUGIN FOLDER NAME HAS BEEN CHANGED **

This is just an add-on for MailPress to replace default SMTP connection by SendMail connection.

== Description ==

**Requires MailPress 1.9.2**

** SINCE 1.9.2 PLUGIN FOLDER NAME HAS BEEN CHANGED **
...
**See** plugin MailPress plugin page at http://www.nogent94.com?page_id=70
